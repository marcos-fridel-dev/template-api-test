...
{
    public class UpdateUserValidator : AbstractValidator<UpdateUserUseCase>
    {
        public UpdateUserValidator(IUnitOfWork unitOfWork, IStringLocalizer localizer)
        {
            ...
            RuleFor(x => x)
                .Must(entity =>
                {
                    ...
                    return !unitOfWork.Users.Exists(x => x.Id != entity.Id && x.UserName == entity.User.UserName);
                })
            ...
            RuleFor(x => x)
                .Must(entity =>
                {
                    ...
                    return !unitOfWork.Users.Exists(x => x.Id != entity.Id && x.Email == entity.User.Email);
                })
                .WithErrorCode(HttpStatusCode.Conflict.ToString())
